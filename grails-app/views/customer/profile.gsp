...
<div id="edit-customer" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: customerInstance, action: 'updateProfile']" method="PUT">
        ...
        <fieldset class="buttons">
            <g:actionSubmit class="save" action="updateProfile"
        ...
        <fieldset class="form">
            ...
            <div class="fieldcontain ${hasErrors(bean: customerInstance, field: 'phone', 'error')} required">
                <span id="phone-label" class="property-label"><g:message code="customer.phone.label"
                                                                         default="Phone"/></span>
                <span class="property-value" aria-labelledby="phone-label"><g:phone334
                        phone="${customerInstance.phone}"/></span>
            </div>
            ...
            <div class="fieldcontain ${hasErrors(bean: customerInstance, field: 'totalPoints', 'error')} required">
                <span id="totalPoints-label" class="property-label"><g:message code="customer.totalPoints.label"
                                                                               default="Total Points"/></span>
                <span class="property-value" aria-labelledby="totalPoints-label"><g:fieldValue
                        bean="${customerInstance}" field="totalPoints"/></span>
...
<div id="list-award" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="awardDate"
                              title="${message(code: 'award.checkinDate.label', default: 'Award Date')}"/>
        ...
        <g:each in="${customerInstance.awards}" status="i" var="checkinInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:phone334
                        phone="${customerInstance.phone}"/></td>
